...
namespace LamiaSimulation
{
    ...
    internal class GlobalState: IActionReceiver, IQueryable, ISimulated
    {
        ...
        public List<string> resourceCategories { get; set; } = new();
        ...
        public void Query<T>(ref QueryResult<T> result, ClientQuery query)
        {
            switch(query)
            {
                ...
                case ClientQuery.UpgradesUnlocked:
                    ...
                    break;
                // CurrentDay
                case ClientQuery.CurrentDay:
                    result = new QueryResult<int>(currentDay) as QueryResult<T>;
                    break;
                // ResourceCategories
                case ClientQuery.ResourceCategories:
                    result = new QueryResult<string[]>(resourceCategories.ToArray()) as QueryResult<T>;
                    break;
                // AvailableTasks
                case ClientQuery.AvailableTasks:
                    result = new QueryResult<string[]>(availableTasks.ToArray()) as QueryResult<T>;
                    break;
            }
        ...
        public void PerformAction(ClientAction action, params object[] args)
        {
        ...
        public T Query<T, T1>(ClientQuery query, T1 arg1)
        {
            throw new NotImplementedException();
        }

        public T Query<T, T1, T2>(ClientQuery query, T1 arg1, T2 arg2)
        {
            throw new NotImplementedException();
        }

        public void Query(ClientQuery query, ref QueryResult result)
        {
            throw new NotImplementedException();
        }

        public void Query(ClientQuery query, ref QueryResult result, object arg1)
        {
            throw new NotImplementedException();
        }

        public void Query(ClientQuery query, ref QueryResult result, object arg1, object arg2)
        {
            throw new NotImplementedException();
        }
    }
