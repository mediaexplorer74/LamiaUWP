...
namespace LamiaSimulation
{
    public class Simulation : IActionReceiver, ISimulated
    {
        ...
        public Simulation()
        {
            ...
            var dataDir = Consts.FilenameDataDirectory;
        ...
        public void Start()
        {
            ...
            //!
            PerformAction(ClientAction.UnlockTask, "cut_trees");
        ...
        public void SaveGame()
        {
            StorageFolder localFolder = ApplicationData.Current.LocalFolder; // папка LocalState
            var jsonString = JsonConvert.SerializeObject(globalState, Formatting.Indented);
            File.WriteAllText(ApplicationData.Current.LocalFolder.Path + "\\" + Consts.FilenameSaveFile, jsonString);
        }
        ...
        public void LoadGame()
        {
            ...
            if (!File.Exists(Consts.FilenameSaveFile))
                return;
            var jsonString = File.ReadAllText(ApplicationData.Current.LocalFolder.Path + "\\" + Consts.FilenameSaveFile);
            globalState = JsonConvert.DeserializeObject<GlobalState>(jsonString);
            LoadedFromSave();
        }
